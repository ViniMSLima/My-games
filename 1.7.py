    ...
    while run:
        ...
        for o in obs:
            ...
            if player.dog_rect.colliderect(o.rect):
                pygame.time.delay(2000) #em milisegundos
                contador_morte +=1
                menu(contador_morte)
...
def menu(contador_morte):
    ...
    while run:
        ...
        if contador_morte == 0:
            text = font.render("Precione qualquer botao para iniciar", True, (0, 0, 0,))
        elif contador_morte > 0:
            text = font.render("Precione qualquer botao para reiniciar", True, (0, 0, 0,))
            score = font.render("Sua pontuacao: " + str(points), (0, 0, 0))
